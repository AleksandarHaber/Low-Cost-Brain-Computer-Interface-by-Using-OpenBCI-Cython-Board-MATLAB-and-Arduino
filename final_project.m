...
arduino=serial('/dev/cu.usbmodem1101','BaudRate',9600,'DataBits',8);    
...
ard_str=[num2str(converted_signal),'123>'];
fprintf(arduino,ard_str)%send the control sequence for direction ;
pause(0.45);
end
